...
import profile1 from "./images/filler.jpg"
    ...
    <div style={{height:'100vh', backgroundColor:'#F1F1F1', width:'100vw', overflow:'clip'}}>
      ...
      <div style={{display:'flex'}}>
        ...
        <div style={{position:'relative', top:'20vh', width:'30vw', left:'20vw'}}>
            <div style={{fontFamily:'Dosis', fontSize:'5vh', borderBottomStyle:'solid'}}>About Us</div>
            ...
            <div style={{fontFamily:'Dosis', fontSize:'5vh', borderBottomStyle:'solid'}}>Our story</div>
